...
public class CreatePostCommandHandler {
    ...
    @Transactional
    public Long handle(CreatePostCommandDTO command) {
        // 1. 입력값 유효성 검증
    ...
    private void validateCreatePostCommand(CreatePostCommandDTO command) {
    ...
    private Post createPostFromCommand(CreatePostCommandDTO command) {
        return Post.builder()
