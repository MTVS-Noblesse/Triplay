...
import com.noblesse.backend.post.command.application.dto.CreatePostCommentCommandDTO;
...
public class CreatePostCommentCommandHandler {
    ...
    @Transactional
    public Long handle(CreatePostCommentCommandDTO command) {
        // 1. 입력값 유효성 검증
    ...
    private void validateCreatePostCommentCommand(CreatePostCommentCommandDTO command) {
    ...
    private PostComment createPostCommentFromCommand(CreatePostCommentCommandDTO command) {
